...
# # Step 2: Redirect the user to the Google OAuth consent screen
# # Step 3: Include the necessary query parameters for OAuth authorization


class GoogleCalendarInitView(View):
    """
    Initiating OAuth2 authorization flow.
    """
...
# To get events from Google Calender
class GoogleCalendarEventsView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        # Min time
        timeMin = '2023-05-29T00:00:00-17:00'
